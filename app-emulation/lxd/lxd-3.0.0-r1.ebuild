...
# We have the rename the distfile because the 3.0.0-r1 distfile doesn't have
...
SRC_URI="https://linuxcontainers.org/downloads/${PN}/${P}.tar.gz -> ${P}-r1.tar.gz"
...
# in ebuild complexity compared to pre 3.0.0-r1 ebuilds.
src_compile() {
